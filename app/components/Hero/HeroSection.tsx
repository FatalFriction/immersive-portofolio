...
export default function HeroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-svh overflow-hidden bg-(--dna-night) px-4 pb-8 pt-20 sm:px-6 sm:pb-10 sm:pt-24 lg:px-10"
    >
      <HeroNavbar />

      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,92,73,0.18),transparent_22%),radial-gradient(circle_at_center_right,rgba(163,143,232,0.16),transparent_20%),linear-gradient(180deg,#111113_0%,#070708_20%,#19191b_100%)]" />
